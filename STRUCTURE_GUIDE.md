...
This guide describes where code lives, what each module owns, and how telemetry flows through the platform. (Canonical copy also under `docs/STRUCTURE_GUIDE.md`.)
