...
from neuroram.backend.daa.optimizer import build_actionable_guidance, greedy_optimization_strategy
...
def get_theme_tokens(theme_mode: str, dark_variant: str) -> dict[str, object]:
    if theme_mode == "Light":
        return {
            ...
            "chart_multi": ["#1976d2", "#3b82f6", "#c2410c", "#0369a1", "#b45309"],
        }

    # Dark: near-black base with blue/gold accents.
    dark_palettes: dict[str, dict[str, object]] = {
        "Midnight Indigo": {
            "bg": (
                ...
                "linear-gradient(155deg, #050505 0%, #09090b 46%, #0d0d10 100%)"
            ),
            "text": "#f8fafc",
            "sub": "#93c5fd",
            "card": "linear-gradient(125deg, rgba(15,15,18,0.95) 0%, rgba(10,10,13,0.97) 100%)",
            "top": "linear-gradient(115deg, rgba(59,130,246,0.14) 0%, rgba(11,11,14,0.95) 45%, rgba(245,158,11,0.10) 100%)",
            "accent": "#3b82f6",
        ...
        "Neon Slate": {
            "bg": (
                ...
                "linear-gradient(150deg, #040405 0%, #09090d 48%, #0e0e12 100%)"
            ),
            "text": "#f8fafc",
            "sub": "#93c5fd",
            "card": "linear-gradient(125deg, rgba(14,14,18,0.95) 0%, rgba(10,10,14,0.97) 100%)",
            "top": "linear-gradient(115deg, rgba(59,130,246,0.15) 0%, rgba(10,10,14,0.95) 45%, rgba(202,138,4,0.13) 100%)",
            "accent": "#3b82f6",
            "grid": "rgba(226,232,240,0.10)",
            "chart_actual": "#60A5FA",
            "chart_pred": "#f59e0b",
        ...
        "Carbon Violet": {
            "bg": (
                ...
                "linear-gradient(155deg, #050506 0%, #09090d 44%, #0e0e13 100%)"
            ),
            "text": "#f8fafc",
            "sub": "#93c5fd",
            "card": "linear-gradient(125deg, rgba(17,15,19,0.95) 0%, rgba(11,11,15,0.97) 100%)",
            "top": "linear-gradient(115deg, rgba(59,130,246,0.14) 0%, rgba(11,11,15,0.95) 45%, rgba(245,158,11,0.11) 100%)",
            "accent": "#3b82f6",
            "grid": "rgba(226,232,240,0.10)",
            "chart_actual": "#60A5FA",
            "chart_pred": "#fbbf24",
...
def inject_styles(theme_mode: str, dark_variant: str, compact_mode: bool = False) -> None:
    ...
    status_bg = "rgba(255,255,255,0.88)" if is_light else "rgba(14,14,18,0.92)"
